...
import ken from "../../Assets/Projects/ken.png";
import fazzress from "../../Assets/Projects/fazzress.png";

const ProffesionalProjectsData = [
  {
    imgPath: ken,
    title: "Pukado ERP System",
    description:
      "Working as a programmer at Ken Solusindo, I am developing an ERP system using Webix for the frontend and CodeIgniter 4 as the backend framework, with PostgreSQL as the database. My responsibilities include building core ERP modules, optimizing system workflows, and ensuring seamless integration across different business processes. This role allows me to collaborate in a dynamic team environment to deliver efficient and scalable enterprise solutions.",
    tags: [
      { name: "Webix", color: "primary" },
      { name: "CodeIgniter 4", color: "success" },
...
const WebsiteProjectsData = [
  {
    imgPath: fazzress,
    title: "Fazzress Ai Agent",
    description:
      "Developed the frontend of Fazzress, an AI-powered customer service agent platform for businesses in Indonesia that manages the entire customer journey from initial chat to payment | Built and maintained admin and client dashboards using React.js (Vite) with clean architecture, reusable components, and custom hooks | Integrated multiple microservices (AI, chat, admin, billing) to enable real-time responses, automated follow-ups, and seamless in-chat transactions | Focused on delivering efficient, consistent, and scalable user experiences across the platform.",
    tags: [{ name: "ReactJs", color: "primary" }],
    ghLink: "",
    demoLink: "#",
  },
  {
  ...
  },
  {
    ...
    description:
      "Developed a comprehensive attendance management system for Duds Space Café Semarang using Laravel 10 and MySQL. The system implements selfie-based attendance with real-time GPS location tracking to ensure accurate and secure check-ins. Additional features include attendance recaps, overtime tracking, leave and permission requests, and an admin dashboard for efficient workforce management and reporting.",
    tags: [
    ...
    ghLink: "https://github.com/AzisWh/duds-absensi",
    demoLink: "#",
  },
  {
    imgPath: choolifah,
    ...
    <Container fluid className="project-section">
      ...
      <Container>
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          {ProffesionalProjectsData.map((project, index) => (
